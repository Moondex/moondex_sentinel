...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to moondexd "gobject list" output
    ...
    def moondexd_serialise(self):
        import moondexlib
        return moondexlib.SHIM_serialise_for_moondexd(self.serialise())
