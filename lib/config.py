...
sentinel_cfg = MoondexConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_moondexd_proto_version_with_sentinel_ping = 70207


def get_moondex_conf():
    home = os.environ.get('HOME')

    moondex_conf = os.path.join(home, ".moondexcore/moondex.conf")
    if sys.platform == 'darwin':
        moondex_conf = os.path.join(home, "Library/Application Support/MoondexCore/moondex.conf")

    moondex_conf = sentinel_cfg.get('moondex_conf', moondex_conf)
